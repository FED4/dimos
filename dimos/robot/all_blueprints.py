...
all_blueprints = {
    ...
    "coordinator-nero-bimanual": "dimos.robot.manipulators.nero.blueprints.basic:coordinator_nero_bimanual",
    "coordinator-nero-cartesian-bimanual": "dimos.robot.manipulators.nero.blueprints.cartesian:coordinator_nero_cartesian_bimanual",
    "coordinator-nero-cartesian-bimanual-mock": "dimos.robot.manipulators.nero.blueprints.cartesian:coordinator_nero_cartesian_bimanual_mock",
    "coordinator-nero-cartesian-left": "dimos.robot.manipulators.nero.blueprints.cartesian:coordinator_nero_cartesian_left",
    "coordinator-nero-cartesian-mock": "dimos.robot.manipulators.nero.blueprints.cartesian:coordinator_nero_cartesian_mock",
    "coordinator-nero-cartesian-right": "dimos.robot.manipulators.nero.blueprints.cartesian:coordinator_nero_cartesian_right",
    "coordinator-nero-left": "dimos.robot.manipulators.nero.blueprints.basic:coordinator_nero_left",
    "coordinator-nero-mock": "dimos.robot.manipulators.nero.blueprints.basic:coordinator_nero_mock",
    "coordinator-nero-poke-left": "dimos.robot.manipulators.nero.blueprints.cartesian:coordinator_nero_poke_left",
    "coordinator-nero-poke-mock": "dimos.robot.manipulators.nero.blueprints.cartesian:coordinator_nero_poke_mock",
    "coordinator-nero-poke-right": "dimos.robot.manipulators.nero.blueprints.cartesian:coordinator_nero_poke_right",
    "coordinator-nero-right": "dimos.robot.manipulators.nero.blueprints.basic:coordinator_nero_right",
    "coordinator-nero-servo-bimanual": "dimos.robot.manipulators.nero.blueprints.basic:coordinator_nero_servo_bimanual",
    "coordinator-nero-servo-left": "dimos.robot.manipulators.nero.blueprints.basic:coordinator_nero_servo_left",
    "coordinator-nero-servo-right": "dimos.robot.manipulators.nero.blueprints.basic:coordinator_nero_servo_right",
    "coordinator-nero-teleop-bimanual": "dimos.robot.manipulators.nero.blueprints.basic:coordinator_nero_teleop_bimanual",
    "coordinator-nero-teleop-mock": "dimos.robot.manipulators.nero.blueprints.basic:coordinator_nero_teleop_mock",
    ...
    "teleop-quest-nero-bimanual": "dimos.robot.manipulators.nero.blueprints.quest_teleop:teleop_quest_nero_bimanual",
    "teleop-quest-nero-bimanual-mock": "dimos.robot.manipulators.nero.blueprints.quest_teleop:teleop_quest_nero_bimanual_mock",
    "teleop-quest-nero-bimanual-move-j": "dimos.robot.manipulators.nero.blueprints.quest_teleop:teleop_quest_nero_bimanual_move_j",
    "teleop-quest-nero-bimanual-move-j-mock": "dimos.robot.manipulators.nero.blueprints.quest_teleop:teleop_quest_nero_bimanual_move_j_mock",
    "teleop-quest-nero-engage-mock": "dimos.robot.manipulators.nero.blueprints.quest_teleop:teleop_quest_nero_engage_mock",
    "teleop-quest-nero-left": "dimos.robot.manipulators.nero.blueprints.quest_teleop:teleop_quest_nero_left",
    "teleop-quest-nero-left-move-j": "dimos.robot.manipulators.nero.blueprints.quest_teleop:teleop_quest_nero_left_move_j",
    "teleop-quest-nero-right": "dimos.robot.manipulators.nero.blueprints.quest_teleop:teleop_quest_nero_right",
    "teleop-quest-nero-right-move-j": "dimos.robot.manipulators.nero.blueprints.quest_teleop:teleop_quest_nero_right_move_j",
    "teleop-quest-nero-telemetry": "dimos.robot.manipulators.nero.blueprints.quest_teleop:teleop_quest_nero_telemetry",
...
all_modules = {
    ...
    "nero-bimanual-quest-teleop-module": "dimos.robot.manipulators.nero.quest_teleop_module.NeroBimanualQuestTeleopModule",
    "nero-cartesian-pattern-module": "dimos.robot.manipulators.nero.cartesian_pattern_module.NeroCartesianPatternModule",
    "nero-controller-stream-module": "dimos.robot.manipulators.nero.quest_stream_module.NeroControllerStreamModule",
    "nero-pattern-planner-module": "dimos.robot.manipulators.nero.pattern_planner_module.NeroPatternPlannerModule",
